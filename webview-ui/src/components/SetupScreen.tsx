  ...
  return (
    <div className="setup-screen">
      ...
      <p className="setup-subtitle">
        Conduit needs the Claude Code CLI to work. Let's get you set up.
      </p>
      ...
      <div className="setup-steps">
        ...
        >
          ...
          <div className="setup-step-content">
            <div className="setup-step-label">Install Claude Code CLI</div>
            {!cliInstalled && (
        ...
        >
          ...
          <div className="setup-step-content">
            <div className="setup-step-label">Authenticate with Claude</div>
            {cliInstalled && !cliAuthenticated && (
              <div className="setup-step-detail">
                <p className="setup-step-hint">
                  Run <code>claude</code> and follow the CLI instructions to
                  authenticate.
                </p>
                <button
